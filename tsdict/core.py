"""
Core TreeSequenceDictionary class for tsdict.
"""
...
class TreeSequenceDictionary:
    ...
    def dump(self, path, *, compress=False):
        ...
        This is a convenience wrapper around :func:`tsdict.io.dump`.
    ...
    def to_ts(self, record_provenance=True):
        ...
        This is a convenience wrapper around :func:`tsdict.convert.to_ts`.
        See that function for full documentation.
